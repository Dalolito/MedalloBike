                ...
                <form method="POST" action="{{ route('admin.product.save') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="image" name="image"
                            placeholder="{{ __('admin.products.create.form.image') }}" value="{{ old('image') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price"
                            placeholder="{{ __('admin.products.create.form.price') }}" value="{{ old('price') }}"
                            step="0.01" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="stock" name="stock"
                            placeholder="{{ __('admin.products.create.form.stock') }}" value="{{ old('stock') }}"
                            required>
                    </div>
