    ...
    <div class="card">
        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="{{ route('admin.category.edit', ['id' => $viewData['category']->getId()]) }}" class="btn btn-light btn-sm me-1">
                    <i class="bi bi-pencil-fill"></i> {{ __('admin.category.show.edit_category') }}
                </a>
                
                <!-- Enable/Disable button -->
                @if($viewData['category']->getState() == 'available')
                    <a class="btn btn-warning btn-sm me-1" href="{{ route('admin.category.disable', ['id' => $viewData['category']->getId()]) }}">
                        <i class="bi bi-toggle-off"></i> {{ __('admin.category.list.disable') }}
                    </a>
                @else
                    <a class="btn btn-success btn-sm me-1" href="{{ route('admin.category.enable', ['id' => $viewData['category']->getId()]) }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('admin.product.show', ['id' => $product->getId()]) }}" 
                                                    class="btn btn-sm btn-info" title="{{ __('admin.products.list.show_product') }}">
