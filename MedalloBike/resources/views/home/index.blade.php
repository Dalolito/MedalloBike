                            ...
                            <div class="card-body">
                                <ul style="list-style: none; padding: 0;">
                                    <li style="margin-bottom: 10px;"><i
                                            class="bi bi-check-circle text-primary me-2"></i>{{ __('app.services.sales') }}
                                    </li>
                                    <li style="margin-bottom: 10px;"><i
                                            class="bi bi-check-circle text-primary me-2"></i>{{ __('app.services.maintenance') }}
                                    </li>
                                    <li style="margin-bottom: 10px;"><i
                                            class="bi bi-check-circle text-primary me-2"></i>{{ __('app.services.consulting') }}
                                    </li>
                                    <li style="margin-bottom: 10px;"><i
                                            class="bi bi-check-circle text-primary me-2"></i>{{ __('app.services.routes') }}
                                    </li>
                                    <li><i
                                            class="bi bi-check-circle text-primary me-2"></i>{{ __('app.services.community') }}
                                    </li>
                                </ul>
                            </div>
                        </div>
